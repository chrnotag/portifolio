  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(color: DarkBlueColor, shadows: List.generate(1, (index) {
      ...
      body: Container(
        decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage(Assets.patternBrancoAzul),
